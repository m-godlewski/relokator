...
class Account(AbstractUser):
    ...
    name = models.CharField(max_length=100, unique=False, blank=False, verbose_name="Imię")
    surname = models.CharField(max_length=100, unique=False, blank=True, verbose_name="Nazwisko")
    ...
    profile_image = models.ImageField(upload_to='profile_images/', blank=True, null=True, verbose_name="Zdjęcie profilowe")
